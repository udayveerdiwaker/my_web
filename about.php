      ...
      <img src="<?php echo 'image/' . $settings['images'] ?>" class="img-fluid" width="100%">
        ...
        <div class="col-lg-8 content">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Name : </strong> <span> <?php echo  $settings['first_name'] ?></span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Birthday : </strong> <span> 8 jan 2005</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Phone : </strong> <span> +19 <?php echo  $settings['number'] ?></span></li>
            ...
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Email : </strong> <span><a href="" data-cfemail="640109050d0824011c05091408014a070b09"> <?php echo  $settings['email'] ?></a></span></li>
              </ul>
            </div>
          </div>
        </div>
